...
![a man's gotta have a code](https://media.giphy.com/media/dxPffVjOhrC4U/source.gif)
...
In the end I was able to adhere to these rules for the *most part*, which felt great! I created something that I now quite enjoy working with, so let's next enumerate the implementation details and explain the rationale behind the decisions made!
